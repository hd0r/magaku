...
function ResetPassword() {
  ...
  const handleSendCode = async () => {
    try {
      await axios.post('https://intensive-natty-haider-ali-d367db1a.koyeb.app/send-verification-code', { email }, { withCredentials: true });
  ...
  const handleResetPassword = async (event) => {
    ...
    try {
      await axios.post('https://intensive-natty-haider-ali-d367db1a.koyeb.app/reset-password', { email, verificationCode, newPassword });
